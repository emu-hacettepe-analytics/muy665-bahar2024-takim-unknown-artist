...
ggplot(total_sales_data, aes(x = Year, y = Total_Sales, fill = Year)) +
  ...
  labs(title = "2022 ve 2023 Yıllarındaki Toplam Konut Satışları",
       x = "Yıl",
       y = "Toplam Satış Sayısı") +
...
p <- ggplot(data_long, aes(x = SEHIR, y = Toplam_Satis / 1000, fill = Yil)) +
  ...
  labs(title = "Deprem Sonrası Göç Alan İllerde Konut Satışları",
       x = "İl",
       y = "Toplam Konut Satışı (bin)",
       fill = "Yıl")
